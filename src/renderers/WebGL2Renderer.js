...
function WebGL2Renderer( parameters ) {
	...
	console.log( 'B3D.WebGL2Renderer', REVISION );
	...
	try {
		...
		console.error( 'B3D.WebGL2Renderer: ' + error );
	...
	function render( scene, camera ) {
		...
		if ( camera !== undefined && camera.isCamera !== true ) {
			...
			console.error( 'B3D.WebGL2Renderer.render: camera is not an instance of B3D.Camera.' );
			return;
