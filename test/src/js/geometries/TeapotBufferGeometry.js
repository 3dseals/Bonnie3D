 ...
 *
 * B3D.TeapotBufferGeometry = function ( size, segments, bottom, lid, body, fitLid, blinn )
 *
...
1.5,-0.84,0.075
	...
	var normOut = new B3D.Vector3();
	var v1, v2, v3, v4;

	var gmx = new B3D.Matrix4();
	var tmtx = new B3D.Matrix4();

	var vsp = new B3D.Vector4();
	var vtp = new B3D.Vector4();
	var vdsp = new B3D.Vector4();
	var vdtp = new B3D.Vector4();

	var vsdir = new B3D.Vector3();
	var vtdir = new B3D.Vector3();
	...
	this.setIndex( new B3D.BufferAttribute( indices, 1 ) );
	this.addAttribute( 'position', new B3D.BufferAttribute( vertices, 3 ) );
	this.addAttribute( 'normal', new B3D.BufferAttribute( normals, 3 ) );
	this.addAttribute( 'uv', new B3D.BufferAttribute( uvs, 2 ) );
...
B3D.TeapotBufferGeometry.prototype = Object.create( B3D.BufferGeometry.prototype );
B3D.TeapotBufferGeometry.prototype.constructor = B3D.TeapotBufferGeometry;

B3D.TeapotBufferGeometry.prototype.clone = function () {

	var bufferGeometry = new B3D.TeapotBufferGeometry(
