...
( function() {
  ...
  function DecalGeometry( mesh, position, orientation, size ) {
  	...
  	var plane = new B3D.Vector3();

  	// this matrix represents the transformation of the decal projector

  	var projectorMatrix = new B3D.Matrix4();
  	projectorMatrix.makeRotationFromEuler( orientation );
  	projectorMatrix.setPosition( position );

  	var projectorMatrixInverse = new B3D.Matrix4().getInverse( projectorMatrix );
  	...
  	this.addAttribute( 'uv', new B3D.Float32BufferAttribute( uvs, 2 ) );
  ...
  DecalGeometry.prototype = Object.create( B3D.BufferGeometry.prototype );
  ...
  B3D.DecalGeometry = DecalGeometry;
