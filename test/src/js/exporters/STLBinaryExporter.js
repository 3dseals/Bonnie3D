...
B3D.STLBinaryExporter = function () {};

B3D.STLBinaryExporter.prototype = {

	constructor: B3D.STLBinaryExporter,
	...
	parse: ( function () {
		...
		return function parse( scene ) {
			...
			scene.traverse( function ( object ) {
				...
				if ( ! ( object instanceof B3D.Mesh ) ) return;
				...
				if ( ! ( geometry instanceof B3D.Geometry ) ) return;
