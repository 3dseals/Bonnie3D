...
B3D.SimplifyModifier = function() {

};

(function() {

	var cb = new B3D.Vector3(), ab = new B3D.Vector3();
	...
	B3D.SimplifyModifier.prototype.modify = function( geometry, count ) {

		if ( geometry instanceof B3D.BufferGeometry && !geometry.vertices && !geometry.faces ) {
		...
		var newGeometry = new B3D.Geometry();
		...
		for ( i = 0; i < faces.length; i ++ ) {
			...
			var tri = faces[ i ];
			newGeo.faces.push( new B3D.Face3(
