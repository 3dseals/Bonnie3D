...
B3D.VREffect = function ( renderer, onError ) {

	var vrDisplay, vrDisplays;
	var eyeTranslationL = new B3D.Vector3();
	var eyeTranslationR = new B3D.Vector3();
	var renderRectL, renderRectR;
	var headMatrix = new B3D.Matrix4();
	var eyeMatrixL = new B3D.Matrix4();
	var eyeMatrixR = new B3D.Matrix4();
	...
	if ( navigator.getVRDisplays ) {
		...
		navigator.getVRDisplays().then( gotVRDisplays ).catch( function () {
			...
			console.warn( 'B3D.VREffect: Unable to get VR Displays' );
	...
	this.getVRDisplays = function () {
		...
		console.warn( 'B3D.VREffect: getVRDisplays() is being deprecated.' );
		return vrDisplays;
	...
	var cameraL = new B3D.PerspectiveCamera();
	cameraL.layers.enable( 1 );

	var cameraR = new B3D.PerspectiveCamera();
	...
	this.render = function ( scene, camera, renderTarget, forceClear ) {
		...
		if ( vrDisplay && scope.isPresenting ) {
			...
			if ( Array.isArray( scene ) ) {
				...
				console.warn( 'B3D.VREffect.render() no longer supports arrays. Use object.layers instead.' );
				scene = scene[ 0 ];
	...
	var poseOrientation = new B3D.Quaternion();
	var posePosition = new B3D.Vector3();
