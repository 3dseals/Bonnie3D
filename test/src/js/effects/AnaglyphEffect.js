...
B3D.AnaglyphEffect = function ( renderer, width, height ) {

	// Matrices generated with angler.js https://github.com/tschw/angler.js/
	// (in column-major element order, as accepted by WebGL)

	this.colorMatrixLeft = new B3D.Matrix3().fromArray( [
	...
	this.colorMatrixRight = new B3D.Matrix3().fromArray( [
	...
	var _renderTargetL = new B3D.WebGLRenderTarget( width, height, _params );
	var _renderTargetR = new B3D.WebGLRenderTarget( width, height, _params );
