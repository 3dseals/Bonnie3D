	...
	'skinSimple' : {
		...
		uniforms: B3D.UniformsUtils.merge( [
...

			{
				...
				"diffuse": { value: new B3D.Color( 0xeeeeee ) },
				"specular": { value: new B3D.Color( 0x111111 ) },
				"opacity": { value: 1 },
				...
				"offsetRepeat": { value: new B3D.Vector4( 0, 0, 1, 1 ) },

				"uWrapRGB": { value: new B3D.Vector3( 0.75, 0.375, 0.1875 ) }
