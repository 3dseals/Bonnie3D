...
B3D.TypedArrayUtils.quicksortIP = function ( arr, eleSize, orderElement ) {
 ...
 *
 * If you want to further minimize memory usage, remove Node.depth and replace in search algorithm with a traversal to root node (see comments at B3D.TypedArrayUtils.Kdtree.prototype.Node)
 */

 B3D.TypedArrayUtils.Kdtree = function ( points, metric, eleSize ) {
	...
	function buildTree( points, depth, parent, pos ) {
		...
		B3D.TypedArrayUtils.quicksortIP( points, eleSize, dim );
	...
	this.nearest = function ( point, maxNodes, maxDistance ) {
		...
		*/
		...
		bestNodes = new B3D.TypedArrayUtils.Kdtree.BinaryHeap(
 ...
 */
B3D.TypedArrayUtils.Kdtree.prototype.Node = function ( obj, depth, parent, pos ) {
...
B3D.TypedArrayUtils.Kdtree.BinaryHeap = function ( scoreFunction ) {
...
B3D.TypedArrayUtils.Kdtree.BinaryHeap.prototype = {
