...
( function( Curves ) {
	...
	GrannyKnot.prototype = Object.create( B3D.Curve.prototype );
	...
	GrannyKnot.prototype.getPoint = function( t ) {
		...
		return new B3D.Vector3( x, y, z ).multiplyScalar( 20 );
	...
	HeartCurve.prototype = Object.create( B3D.Curve.prototype );
	...
	HeartCurve.prototype.getPoint = function( t ) {
		...
		return new B3D.Vector3( x, y, z ).multiplyScalar( this.scale );
	...
	VivianiCurve.prototype = Object.create( B3D.Curve.prototype );
	...
	KnotCurve.prototype = Object.create( B3D.Curve.prototype );
	...
	HelixCurve.prototype = Object.create( B3D.Curve.prototype );
	...
	TrefoilKnot.prototype = Object.create( B3D.Curve.prototype );
	...
	TorusKnot.prototype = Object.create( B3D.Curve.prototype );
	...
	CinquefoilKnot.prototype = Object.create( B3D.Curve.prototype );
	...
	TrefoilPolynomialKnot.prototype = Object.create( B3D.Curve.prototype );
	...
	FigureEightPolynomialKnot.prototype = Object.create( B3D.Curve.prototype );
	...
	DecoratedTorusKnot4a.prototype = Object.create( B3D.Curve.prototype );
	...
	DecoratedTorusKnot4b.prototype = Object.create( B3D.Curve.prototype );
	...
	DecoratedTorusKnot5a.prototype = Object.create( B3D.Curve.prototype );
	...
	DecoratedTorusKnot5c.prototype = Object.create( B3D.Curve.prototype );
