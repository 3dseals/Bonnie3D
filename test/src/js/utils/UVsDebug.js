 ...
 *
 * Sample usage:
 *	document.body.appendChild( B3D.UVsDebug( new B3D.SphereGeometry( 10, 10, 10, 10 ) );
 *
 */
 
B3D.UVsDebug = function( geometry, size ) {
	...
	var a = new B3D.Vector2();
	var b = new B3D.Vector2();

	var geo = ( geometry instanceof B3D.BufferGeometry ) ? new B3D.Geometry().fromBufferGeometry( geometry ) : geometry;
