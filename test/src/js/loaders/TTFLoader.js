 ...
 * to create B3D.Font objects
 */

'use strict';

B3D.TTFLoader = function ( manager ) {
...
B3D.TTFLoader.prototype.load = function ( url, onLoad, onProgress, onError ) {
...
B3D.TTFLoader.prototype.parse = function ( arraybuffer ) {
