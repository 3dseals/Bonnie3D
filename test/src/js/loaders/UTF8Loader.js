...
B3D.UTF8Loader = function () {};

/**
 * Load UTF8 encoded model
 * @param jsonUrl - URL from which to load json containing information about model
 * @param callback - Callback(B3D.Object3D) on successful loading of model
 * @param options - options on how to load model (see B3D.MTLLoader.MaterialCreator for basic options)
...
B3D.UTF8Loader.prototype.load = function ( jsonUrl, callback, options ) {
...
B3D.UTF8Loader.BufferGeometryCreator = function () {
};

B3D.UTF8Loader.BufferGeometryCreator.prototype.create = function ( attribArray, indices ) {
...
B3D.UTF8Loader.prototype.decompressAttribsInner_ = function ( str, inputStart, inputEnd,
...
B3D.UTF8Loader.prototype.decompressIndices_ = function( str, inputStart, numIndices,
                                                            output, outputStart ) {
...
B3D.UTF8Loader.prototype.decompressAABBs_ = function ( str, inputStart, numBBoxen,
...
B3D.UTF8Loader.prototype.decompressMesh =  function ( str, meshParams, decodeParams, name, idx, callback ) {
...
B3D.UTF8Loader.prototype.copyAttrib = function ( stride, attribsOutFixed, lastAttrib, index ) {
...
B3D.UTF8Loader.prototype.decodeAttrib2 = function ( str, stride, decodeOffsets, decodeScales, deltaStart,
...
B3D.UTF8Loader.prototype.accumulateNormal = function ( i0, i1, i2, attribsOutFixed, crosses ) {
...
B3D.UTF8Loader.prototype.decompressMesh2 = function( str, meshParams, decodeParams, name, idx, callback ) {
...
B3D.UTF8Loader.prototype.downloadMesh = function ( path, name, meshEntry, decodeParams, callback ) {
...
B3D.UTF8Loader.prototype.downloadMeshes = function ( path, meshUrlMap, decodeParams, callback ) {
...
B3D.UTF8Loader.prototype.createMeshCallback = function( materialBaseUrl, loadModelInfo, allDoneCallback ) {
	...
	for ( var url in meshUrlMap ) {
		...
		modelParts[ url ] = new B3D.Object3D();

	}

	var model = new B3D.Object3D();

    // Prepare materials first...

	var materialCreator = new B3D.MTLLoader.MaterialCreator( materialBaseUrl, loadModelInfo.options );
	...
	var bufferGeometryCreator = new B3D.UTF8Loader.BufferGeometryCreator();
	...
	var meshCallback = function( name, idx, attribArray, indexArray, bboxen, meshParams ) {
        ...
        //model.add(new B3D.Mesh(geometry, material));
...
B3D.UTF8Loader.prototype.downloadModel = function ( geometryBase, materialBase, model, callback ) {
...
B3D.UTF8Loader.prototype.downloadModelJson = function ( jsonUrl, callback, options ) {
