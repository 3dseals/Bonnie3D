...
B3D.SEA3D.prototype.toAmmoVec3 = function ( v ) {
...
B3D.SEA3D.prototype.readSphere = function ( sea ) {
...
B3D.SEA3D.prototype.readBox = function ( sea ) {
...
B3D.SEA3D.prototype.readCone = function ( sea ) {
...
B3D.SEA3D.prototype.readCylinder = function ( sea ) {
...
B3D.SEA3D.prototype.readCapsule = function ( sea ) {
...
B3D.SEA3D.prototype.readConvexGeometry = function ( sea ) {
...
B3D.SEA3D.prototype.readTriangleGeometry = function ( sea ) {
...
B3D.SEA3D.prototype.readCompound = function ( sea ) {
	...
	for ( var i = 0; i < sea.compounds.length; i ++ ) {
		...
		B3D.SEA3D.MTXBUF.elements = compound.transform;

		var transform = SEA3D.AMMO.getTransformFromMatrix( B3D.SEA3D.MTXBUF );
...
B3D.SEA3D.prototype.readRigidBodyBase = function ( sea ) {
	...
	if ( sea.target ) {
		...
		B3D.SEA3D.MTXBUF.fromArray( sea.transform );

		transform = SEA3D.AMMO.getTransformFromMatrix( B3D.SEA3D.MTXBUF );
...
B3D.SEA3D.prototype.readRigidBody = function ( sea ) {
...
B3D.SEA3D.prototype.readCarController = function ( sea ) {
...
B3D.SEA3D.prototype.readP2PConstraint = function ( sea ) {
...
B3D.SEA3D.prototype.readHingeConstraint = function ( sea ) {
...
B3D.SEA3D.prototype.readConeTwistConstraint = function ( sea ) {
...
B3D.SEA3D.Domain.prototype.enabledPhysics = function ( enabled ) {
...
B3D.SEA3D.Domain.prototype.applyContainerTransform = function () {
...
B3D.SEA3D.Domain.prototype.applyTransform = function ( matrix ) {
...
B3D.SEA3D.Domain.prototype.getShape = B3D.SEA3D.prototype.getShape = function ( name ) {

	return this.objects[ "shpe/" + name ];

};

B3D.SEA3D.Domain.prototype.getRigidBody = B3D.SEA3D.prototype.getRigidBody = function ( name ) {

	return this.objects[ "rb/" + name ];

};

B3D.SEA3D.Domain.prototype.getConstraint = B3D.SEA3D.prototype.getConstraint = function ( name ) {

	return this.objects[ "ctnt/" + name ];

};

B3D.SEA3D.EXTENSIONS_LOADER.push( {
...
B3D.SEA3D.EXTENSIONS_DOMAIN.push( {
