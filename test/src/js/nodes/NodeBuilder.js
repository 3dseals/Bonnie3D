...
B3D.NodeBuilder = function( material ) {
...
B3D.NodeBuilder.prototype = {

	constructor: B3D.NodeBuilder,
	...
	getConstructorFromLength : function( len ) {
		...
		return B3D.NodeBuilder.constructors[ len - 1 ];
	...
	getTypeByFormat : function( format ) {
		...
		return B3D.NodeBuilder.type[ format ] || format;
	...
	getElementByIndex : function( index ) {
		...
		return B3D.NodeBuilder.elements[ index ];

	},

	getIndexByElement : function( elm ) {

		return B3D.NodeBuilder.elements.indexOf( elm );
